...
```
	dependencies {
		implementation 'ckrjfrog.FlexItemDecoration:Decoration:1.1.0'//gradle plugin 3.0(inclusive) above used
		//compile 'ckrjfrog.FlexItemDecoration:Decoration:1.1.0'//gradle plugin 3.0 below used
	}
```
